...
export class ChartPageComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.chart = Highcharts.chart(<Highcharts.HTMLDOMElement>this.container.nativeElement, {
      chart: {
        type: 'bar',
      },
      title: {
  ...
  addNewFruit() {
    ...
    this.chart.xAxis[0].setCategories([...this.chart.xAxis[0].categories, fruit]);
